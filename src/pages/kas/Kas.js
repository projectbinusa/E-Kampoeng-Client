...
//        `http://localhost:8000/e-kampoeng/api/e-kas/all?direction=asc&page=${page}&size=${size}&sort=createdDate`,
//         authConfig
//       );
//       setPages(response.data.data.totalPages);
//       setKas(response.data.data.content);
//     } catch (error) {
...
//         try {
//           await axios.delete( api_kas + "delete/" + id, authConfig);
//           Swal.fire({
//             title: "Terhapus!",
...
const kas = [
    {
      pemasukkan: "3.500.000",
      pengeluaran: "1.700.000",
      sisa_kas_bulan_lalu: "1.500.000",
      sisa_kas_bulan_ini: "1.800.000",
      keterangan_pemasukkan: "Kas warga",
      keterangan_pengeluaran: "Acara halal bi halal",
    },
    {
      pemasukkan: "3.500.000",
      pengeluaran: "1.200.000",
      sisa_kas_bulan_lalu: "1.800.000",
      sisa_kas_bulan_ini: "2.300.000",
      keterangan_pemasukkan: "Kas Warga",
      keterangan_pengeluaran: "Syukuran",
    },
  ];
